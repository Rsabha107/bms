...
class MdsNewBookingMail extends Mailable
{
    ...
    {
        return $this->subject('MDS Confirmation for a New Booking Request'.' - ' . $this->details['booking_ref_number'])
            ->view('emails.new_booking')
            ->from('no-reply-mds@example.com', 'MDS')
