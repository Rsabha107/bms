...
--
-- Table structure for table `global_attachments`
--

DROP TABLE IF EXISTS `global_attachments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `global_attachments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `archived` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
...
--
-- Dumping data for table `global_attachments`
--

LOCK TABLES `global_attachments` WRITE;
/*!40000 ALTER TABLE `global_attachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `global_attachments` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-09  9:13:33
