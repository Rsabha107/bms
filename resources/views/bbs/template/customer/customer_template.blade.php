...
<head>
  ...
  <link rel="preload" href="{{ asset('assets/icons/sc-icons.woff2') }}" as="font" type="font/woff2" crossorigin="">
  ...
  <!-- <link rel="stylesheet" href="{{ asset('assets/css/swiper_custom.css') }}"> -->
...
<body>
  ...
  <main class="main" id="top">
    ...
    {{-- @include('mds.operator.layout.header_section') --}}

    @include('bbs.template.customer.header')
    {{-- resources\views\bbs\admin\body\header.blade.php --}}
    {{-- @include('bbs.template.customer.top_nav_section') --}}
    {{-- @include('bbs.template.customer.breadcrumb_section') --}}
    {{-- @include('bbs.template.customer.search_section') --}}
    {{-- @include('bbs.template.customer.sidebar_section') --}}
    ...
    @include('bbs.template.customer.floating_button')
  </main>
