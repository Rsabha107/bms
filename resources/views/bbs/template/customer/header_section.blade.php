        ...
        <div class="ecommerce-topbar">
          <nav class="navbar navbar-expand-lg navbar-light px-0">
            <div class="row gx-0 gy-2 w-100 flex-between-center">
              <div class="col-auto"><a class="text-decoration-none" href="{{ route('bbs.customer.booking.list') }}">
                  <div class="d-flex align-items-center"><img src="{{ asset('assets/img/icons/sc_logo.png') }}" alt="phoenix" width="80" />
                    <h6 class="logo-text ms-2">Broadcast Managed Services</h6>
                  </div>
                </a>
              </div>
