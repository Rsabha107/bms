<nav class="navbar-responsive-navitems navbar-expand navbar-light bg-body-emphasis justify-content-between">
  <div class="container-small d-flex flex-between-center" data-navbar="data-navbar">
            ...
            <div class="row gx-7 gy-5 mb-5">
              ...
              <div class="col-12 col-sm-6 col-md-4">
                <div class="d-flex align-items-center mb-3"><span class="text-primary me-2" data-feather="home" style="stroke-width:3;"></span>
                  <h6 class="text-body-highlight mb-0 text-nowrap">Home</h6>
                </div>
    ...
    <ul class="navbar-nav justify-content-end align-items-center">
      ...
      <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link" href="{{ route('bbs.customer.booking.list') }}">Services</a></li>
      <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-0" href="{{ route('bbs.customer.booking.cart') }}">Confirmed Bookings</a></li>
      <li class="nav-item dropdown" data-nav-item="data-nav-item" data-more-item="data-more-item">
        ...
        <div class="dropdown-menu dropdown-menu-end category-list" aria-labelledby="navbarDropdown" data-category-list="data-category-list">
        </div>
      </li>
    </ul>
  </div>
