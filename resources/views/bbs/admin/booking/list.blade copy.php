...
<head>
  ...
  <link href="{{asset('fnx/vendors/swiper/swiper-bundle.min.css')}}" rel="stylesheet">
</head>
...
<body>
    ...
    <nav class="navbar-responsive-navitems navbar-expand navbar-light bg-body-emphasis justify-content-between">
      <div class="container-small d-flex flex-between-center" data-navbar="data-navbar">
        ...
        <ul class="navbar-nav justify-content-end align-items-center">
          <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link ps-0 active" href="../../../apps/e-commerce/landing/homepage.html">Home</a></li>
                    ...
                    <div class="d-flex flex-column justify-content h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                          ...
                          <img class="img-fluid" src="{{ asset('assets/img/bbs/non-equipped-regular-commentart-position.png') }}" alt="" />
                        </div>
                        <a class="stretched-link" href="javascript:void(0)">
                          <h6 class="mb-2 lh-sm line-clamp-3 product-name">Non-equipped Regular Commentary position</h6>
                        </a>
                      </div>
                      <div>
                        <p class="fs-9 text-body-quaternary fw-bold mb-2">This Position is located on the media tribune</p>
                        <p class="text-body-tertiary fw-semibold fs-9 lh-1 mb-0">5 available</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="d-flex flex-column justify-content h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                          ...
                          <img class="img-fluid" src="{{ asset('assets/img/bbs/non-equipped-multilateral-interviews-position.png') }}" alt="" />
                        </div>
                        <a class="stretched-link" href="javascript:void(0)">
                          <h6 class="mb-2 lh-sm line-clamp-3 product-name">Non-equipped Multilateral Interviews Positions</h6>
                        </a>
                      ...
                      <div>
                        <p class="fs-9 text-body-highlight fw-bold mb-2">one interview per playing team, 90 seconds max each</p>
                        {{-- <div class="d-flex align-items-center mb-1">
                          <p class="me-2 text-body text-decoration-line-through mb-0">$125.00</p>
                          <h3 class="text-body-emphasis mb-0">$89.00</h3>
                        </div> --}}
                        <p class="text-body-tertiary fw-quaternary fs-9 lh-1 mb-0">2 available</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                          ...
                          <img class="img-fluid" src="{{ asset('assets/img/products/2.png') }}" alt="" />
                        </div>
                        <a class="stretched-link" href="javascript:void(0)">
                    ...
                    <div class="d-flex flex-column justify-content-between h-100">
                      <div>
                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                          ...
                          <img class="img-fluid" src="{{ asset('assets/img/products/3.png') }}" alt="" />
                        </div>
                        <a class="stretched-link" href="javascript:void(0)">
                          <h6 class="mb-2 lh-sm line-clamp-3 product-name">PlayStation 5 DualSense Wireless Controller</h6>
                        </a>
                    ...
                    <div class="position-relative text-decoration-none product-card h-100">
                      <div class="d-flex flex-column justify-content-between h-100">
                        <div>
                          ...
                          <p class="fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                          </p>
                        </div>
                        <div>
                    ...
                    <div class="position-relative text-decoration-none product-card h-100">
                      <div class="d-flex flex-column justify-content-between h-100">
                        <div>
                          ...
                          <p class="fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt star-icon text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span>
                          </p>
                        </div>
                        <div>
  ...
  <script src="{{asset('fnx/vendors/swiper/swiper-bundle.min.js') }}"></script>
