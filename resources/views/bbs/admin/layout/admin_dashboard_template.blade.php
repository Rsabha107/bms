...
<body class="nav-slim">
    ...
    <!-- // charts -->
    <script src="{{asset('fnx/assets/js/dashboards/ecommerce-dashboard.js')}}"></script>
    <script src="{{asset('fnx/assets/js/dashboards/projectmanagement-dashboard.js')}}"></script>
    <script src="{{asset('fnx/assets/js/dashboards/crm-dashboard.js')}}"></script>
    <script src="{{asset('fnx/assets/js/pages/crm-analytics.js')}}"></script>
