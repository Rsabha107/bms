...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('assets/img/icons/sc_logo.png') }}">
    ...
    <link href="https://cdn.datatables.net/v/bs5/jq-3.7.0/jszip-3.10.1/dt-1.13.8/b-2.4.2/b-colvis-2.4.2/b-html5-2.4.2/b-print-2.4.2/r-2.5.0/rr-1.4.1/sc-2.3.0/sb-1.6.0/datatables.min.css"
        integrity="m25CKmrBg/89Z5DPIgXmRP0sj9UP6WuDkqTEfkx44HqkcLWxY/kTbi6FySKEgf5W"
        rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.datatables.net/rowgroup/1.4.1/css/rowGroup.dataTables.min.css"
        integrity="2NAdExmXbiSJhyJfJuW1pBfkyLCpS4n+S+DwrmjE2MYXaZCdMnhBtLMGPVhaDN56">
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-table@1.24.2/dist/bootstrap-table.min.css" integrity="1ie48E5ptWCDY9PXLXSMxA+rTXwrP63sKHXh8d9ong3ejEItSDkhid/S5enJvDeB" rel="stylesheet">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.3/font/bootstrap-icons.css" integrity="eoTu3+HydHRBIjnCVwsFyCpUDZHZSFKEJD0mc3ZqSBSb6YhZzRHeiomAUWCstIWo">
...
<body class="nav-slim">
    ...
    <main class="main" id="top">
        ...
        {{-- // start of content --}}
        @include('bbs.customer.body.header')
        {{-- <x-bbs.customer.sidemenu_h /> --}}
        <div class="content">
            @yield('main')
            @include('bbs.customer.partials.labels')
            @include('bbs.customer.body.footer')
        </div>
        {{-- // end of content --}}
    ...
    <script src="{{ asset('assets/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}">
    </script>
