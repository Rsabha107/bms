<div class="offcanvas offcanvas-end custom-offcanvas offcanvas-global-modal in" id="offcanvas-add-parking-variation-modal" tabindex="-1"
    ...
    <x-bbs.customer.booking-drawer formAction="{{ route('customer.booking.cart.store') }}"
        formId="add_booking_form" :services="$services" />
