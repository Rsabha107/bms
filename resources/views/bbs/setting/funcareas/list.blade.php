...
{{-- <div class="content"> --}}
    {{-- <div class="container-fluid"> --}}
        <div class="d-flex justify-content-between m-2">
            ...
            <div>
                <x-button_insert_modal bstitle='Add Functional Area' bstarget="#create_funcareas_modal" />
        ...
        <x-setting.functional-area-card :funcareas="$funcareas" />
    {{-- </div> --}}

    @include('bbs.setting.modals.functional_area_modals')
    <script>
    ...
    <script src="{{asset('assets/js/pages/bbs/setting/functional_area.js')}}"></script>
    @endsection
