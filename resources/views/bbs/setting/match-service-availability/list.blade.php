    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1">
                ...
                <li class="breadcrumb-item active"> Service Availability </li>
            </ol>
        </nav>
    </div>
    <div>

        <x-formy.button_insert_js title='Add Match Service Availability' selectionId="offcanvas-add-match-service-availability" dataId="0"
            table="services_table" icon="fa-solid fa-plus" />
...
<x-setting.match-service-availability-card />
{{-- </div> --}}

@include('bbs.setting.modals.service_availability_modals')
<script>
...
<script src="{{ asset('assets/js/pages/bbs/setting/services_availability.js') }}"></script>
@endsection
