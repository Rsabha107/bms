...
{{-- <div class="content"> --}}
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item active">
                            <?= get_label('venue', 'Venues') ?>
                        </li>
                    </ol>
                </nav>
            </div>
            <div>
                <x-button_insert_modal bstitle='Add Venue' bstarget="#create_venues_modal" />
    ...
    @include('bbs.setting.modals.venue_modals')
    <script>
    ...
    <script src="{{asset('assets/js/pages/bbs/setting/venue.js')}}"></script>
    @endsection
