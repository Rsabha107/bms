<div class="modal fade" id="create_setting_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_application_setting" action="{{route('bbs.setting.application.store')}}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_app_setting_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="edit_form_submit_app_setting" action="{{route('bbs.setting.application.update')}}" method="POST">
                @csrf
