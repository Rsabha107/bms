        ...
        <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-MDS">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('mds/admin/booking')||Request::is('mds/admin/booking/create') ? 'show' : '' }}" data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                ...
                                <li class="nav-item"><a class="nav-link {{ Request::is('mds/admin/booking') ? 'active' : '' }}" href="{{route('bbs.admin.booking')}}">
                                ...
                                <li class="nav-item"><a class="nav-link {{ Request::is('bbs/admin/booking') ? 'active' : '' }}" href="{{route('bbs.admin.booking.list')}}">
                ...
                <li class="nav-item">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('bbs/setting/venue') ? 'active' : '' }}" href="{{route('bbs.setting.venue')}}" role="button" data-bs-toggle="" aria-expanded="false">
