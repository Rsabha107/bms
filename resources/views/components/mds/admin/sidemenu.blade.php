            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-MDS">
                            <div class="d-flex align-items-center">
                                <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="phone"></span></span><span class="nav-link-text">BMS</span>
                            </div>
                        </a>
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('mds/admin/booking')||Request::is('mds/admin/booking/create') ? 'show' : '' }}" data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                <li class="collapsed-nav-item-title d-none">BMS
                                </li>
                                <li class="nav-item"><a class="nav-link {{ Request::is('mds/admin/booking') ? 'active' : '' }}" href="{{route('bbs.customer.booking.cart')}}">
                                ...
                                <li class="nav-item"><a class="nav-link {{ Request::is('bbs/admin/booking') ? 'active' : '' }}" href="{{route('bbs.customer.booking.list')}}">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">Book a Service</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('bbs/setting/service') ? 'active' : '' }}" href="{{route('bbs.setting.service')}}" role="button" data-bs-toggle="" aria-expanded="false">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="compass"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Services</span></span>
                            </div>
                        </a>
                    </div>
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/event') ? 'active' : '' }}" href="{{route('bbs.setting.event')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/venue') ? 'active' : '' }}" href="{{route('bbs.setting.venue')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/driver') ? 'active' : '' }}" href="{{route('bbs.setting.driver')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('mds/setting/vehicle') ? 'active' : '' }}" href="{{route('bbs.setting.vehicle')}}" role="button" data-bs-toggle="" aria-expanded="false">
