                        ...
                        <div class="card-header p-4 border-bottom border-300 bg-soft">
                            <div class="row g-3 justify-content-between align-items-center">
                                ...
                                <div class="col-12 col-md">
                                    <h4 class="text-900 mb-0" data-anchor="data-anchor">Permission List</h4>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <!-- <button class="btn btn-primary me-4" type="button" data-bs-toggle="modal"
                                            ...
                                            Deal</button> -->
                                        <a class="btn btn-sm btn-phoenix-warning preview-btn ms-2"  href="{{ route('sec.perm.import') }}"><span class="fa-solid fa-add"></span>Import</a>
                                        ...
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                            <thead class="text-900 thead">
                                                <tr>
                                                    ...
                                                    <th class="sort pe-1 align-middle white-space-nowrap" data-sort="customer" style="min-width: 2.5rem">Group</th>
                                                    <th class="sort pe-1 align-middle white-space-nowrap" data-sort="customer" style="min-width: 2.5rem">Status</th>
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-3">{{ $item->group_name }}</td>
                                                    @if ( $item->active_flag == 1)
                                                    <td><span class="badge badge-phoenix badge-phoenix-success">Active</span>
                                                    </td>
                                                    @else
                                                    <td><span class="badge badge-phoenix badge-phoenix-warning">Inactive</span>
                                                    </td>
                                                    @endif
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="{{route('sec.perm.edit', $item->id)}}" class="btn btn-sm">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="{{ route('sec.perm.delete',$item->id)}} " class="btn btn-sm delete" id="delete">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('sec.perm.update') }}" method="POST">
                    @csrf
