        ...
        <div class="col-xl-8">
            <div class="d-sm-flex justify-content-between">
                ...
                <div class="d-flex mb-3">
                    <a class="btn btn-phoenix-danger me-2 px-6" href="{{ route('sec.groups.list') }}">Cancel</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-xl-8">
        <form action="{{ route ('sec.groups.create') }}" class="row g-3 mb-9 needs-validation" novalidate="" method="post">
            @csrf
