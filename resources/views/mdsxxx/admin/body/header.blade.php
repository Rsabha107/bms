@php
    ...
    //     $event = App\Models\bbs\MdsEvent::findOrFail($current_event_id);
...
<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
    <div class="collapse navbar-collapse justify-content-between">
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('bbs.admin') }}">
        ...
        @php
            ...
            $user_events = App\Models\Mds\MdsEvent::where('active_flag', 1)->orderBy('name')->get();
        @endphp
        {{-- @hasrole('xxx') --}}
                            ...
                            <div class="scrollbar-overlay" style="height: 27rem;">
                                @foreach ($user_events as $event)
                                    ...
                                    @else
                                        ...
                                        @endphp
                                    @endif
                                    <a href="{{ route('bbs.admin.booking.switch', $event->id) }}"
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar avatar-m {{ $avatar_status }} me-3">
                                                    <img class="rounded-circle"
                                                        src="{{ route('bbs.setting.event.file', $event->event_logo ? $event->event_logo : 'default.png') }}"
                                                        alt="" />
                                                </div>
                                                <div class="flex-1 me-sm-3">
                            ...
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="{{ route('home') }}"><img src="../../assets/img/nav-icons/bitbucket.webp"
                                            alt="" width="30">
                                        <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">bbs</p>
                                    </a>
                                </div>
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                        ...
                        <div class="overflow-auto scrollbar" style="height: 10rem;">
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item"><a class="nav-link px-3 d-block"
                                        href="{{ route('bbs.admin.users.profile') }}"> <span
                                            class="me-2 text-body align-bottom"
                                            data-feather="user"></span><span>Profile</span></a></li>
                                <li class="nav-item"><a class="nav-link px-3 d-block"
                                        href="{{ route('bbs.admin.dashboard') }}"><span
                                            class="me-2 text-body align-bottom"
