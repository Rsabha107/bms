...
@section('main')
        ...
        <div class="card shadow-none border my-4 col-md-8" style="margin:0 auto;" data-component-card="data-component-card">
            ...
            <div class="card-body p-0">
                <div class="p-4 code-to-copy">
                    <form class="row g-3  px-3 needs-validation" action="{{ route('mds.customer.booking.store') }}"
                        ...
                        <x-formy.form_select floating="0" name="driver_id" elementId="add_driver_id"
                            ...
                            itemTitleForeach="full_name" class="col-md-10 mb-2" style="margin:0 auto;" required="required"
                            addDynamicButton="0" dynamicModal="#add_driver_id_modal" />
    ...
    @include('mds.customer.modals.booking_modals')
